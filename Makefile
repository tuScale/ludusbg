...
am__append_6 = -L/usr/lib/python2.7/config-x86_64-linux-gnu -L/usr/lib -lpthread -ldl  -lutil -lm  -lpython2.7 -Xlinker -export-dynamic -Wl,-O1 -Wl,-Bsymbolic-functions 
am__append_7 = -L$(srcdir)/board3d board3d/libboard3d.la $(GTKGLEXT_LIBS) $(GLU_LIBS)
subdir = .
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	$(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/config.h.in mkinstalldirs external_l.c external_y.c \
	sgf_l.c sgf_y.c depcomp ylwrap ABOUT-NLS COPYING TODO compile \
...
ACLOCAL = ${SHELL} /home/vic/Projects/external/gnubg/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_CFLAGS = -g -O2 -DG_DISABLE_ASSERT
AM_DEFAULT_VERBOSITY = 1
AM_YFLAGS = -d
AR = ar
AUTOCONF = ${SHELL} /home/vic/Projects/external/gnubg/missing autoconf
AUTOHEADER = ${SHELL} /home/vic/Projects/external/gnubg/missing autoheader
AUTOMAKE = ${SHELL} /home/vic/Projects/external/gnubg/missing automake-1.14
AWK = mawk
...
LSB_CHECK = yes
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/vic/Projects/external/gnubg/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
YACC = bison -y
YFLAGS = 
abs_builddir = /home/vic/Projects/external/gnubg
abs_srcdir = /home/vic/Projects/external/gnubg
abs_top_builddir = /home/vic/Projects/external/gnubg
abs_top_srcdir = /home/vic/Projects/external/gnubg
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/vic/Projects/external/gnubg/install-sh
...
AM_CPPFLAGS = -I$(srcdir)/lib -I$(srcdir)/board3d -I$(srcdir)/pixmaps \
	...
	-I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include   $(am__append_1) $(am__append_2) \
...
gnubg_LDADD = -L$(srcdir)/lib lib/libevent.la -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lcairo -lpango-1.0 -lfontconfig -lgobject-2.0 -lglib-2.0 -lfreetype   -lpng12   \
	-lcairo   -lpangocairo-1.0 -lpango-1.0 -lcairo -lgobject-2.0 -lglib-2.0   -pthread -lgthread-2.0 -lglib-2.0   -lgobject-2.0 -lglib-2.0   \
	 -lfreetype   -lglib-2.0   -lpng12   \
	 $(OTHER_LIBS) $(am__append_5) $(am__append_6) \
	$(am__append_7)
...
makebearoff_LDADD = -Llib lib/libevent.la  -lglib-2.0   -pthread -lgthread-2.0 -lglib-2.0   -lgobject-2.0 -lglib-2.0  
makehyper_SOURCES = makehyper.c $(UTILSOURCES)
makehyper_LDADD = -Llib lib/libevent.la -lglib-2.0   -pthread -lgthread-2.0 -lglib-2.0   -lgobject-2.0 -lglib-2.0  
bearoffdump_SOURCES = bearoffdump.c $(UTILSOURCES)
bearoffdump_LDADD = -Llib lib/libevent.la -lglib-2.0   -pthread -lgthread-2.0 -lglib-2.0   -lgobject-2.0 -lglib-2.0  
makeweights_SOURCES = makeweights.c
makeweights_LDADD = -Llib lib/libevent.la -lglib-2.0   -pthread -lgthread-2.0 -lglib-2.0   -lgobject-2.0 -lglib-2.0  
